...
<script type='text/babel' src="<?=base_url('assets/ReactJS_Components/User/ListDataUser.js')?>"></script>
<script type='text/babel' src="<?=base_url('assets/ReactJS_Components/User/RowUser.js')?>"></script>
...
<script type='text/babel'>
     ReactDOM.render(<ListDataUser />, document.getElementById('root'));
</script>